...
#FFLAGS = -O0 -g -elfence -fbounds-check -pg
FFLAGS = -O0 -g -fbounds-check #-ftrace=full
#FFLAGS = -g -s
LDFLAGS = -O0 
#LDFLAGS = -g 
...
#F = gfortran #cygwin compiler
F = mpif90 #mpi compiler
#FFLAGS = -O4 -N113 -s -march=host
#LDFLAGS = -O4 

LIBS = -lm
COBJ = 
FOBJ = kinddefs.o blas.o hb_io.o pcomm.o matsol_lib.o armslib.o ilut.o ilutp.o pilu.o arms2.o linalg.o linSolver.o
#FOBJ = kinddefs.o blas.o hb_io.o pcomm.o pcomm_interface.o matsol_lib.o armslib.o ilut.o ilutp.o pilu.o arms2.o linalg.o linSolver.o
...
#pcomm_interface.o: pcomm_interface.f90
#	$(F) -c $(FFLAGS) $*.f90  
